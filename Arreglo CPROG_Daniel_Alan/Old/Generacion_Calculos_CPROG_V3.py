...
#tipo_label=Label(text="Tipo de calculo",font=("Arial",10))
#tipo_label.place(x=50,y=110) #Ubicación del texto de las variables de ingreso
...
#Texto2=Entry(raiz_guide, textvariable=tipo_usr,width="40")
#Texto2.place(x=50,y=140)
...
wb.save('Cargos CPROG_'+str(Mes_str)+"_"+str(tipo)+'_V2_2.xlsx')
wb.save('Cargos CPROG.xlsx')
