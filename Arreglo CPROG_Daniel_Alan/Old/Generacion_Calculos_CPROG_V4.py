...
uti.Copiar_hoja_Excel('FechaIniVig', 'FechaIniVig2', 'Cargos CPROG.xlsx', wb)
wb = load_workbook('Cargos CPROG.xlsx')
...
raiz_guide.geometry("350x250") #Definir el tamaño de la ventana
...
result_3.dropna(axis=0, inplace=True)
...
for Age in Agentes:
    ...
    uti.Copiar_Valor_Variable_Excel('tipo', wb,tipo)   
    # Guarda el libro
    wb.save('Cargos CPROG.xlsx')
    ...
    mapeo_agente = uti.Consulta_mapeo_nombre_agente(Ung_query)
    ...
    uti.Copiar_hoja_Excel('CargoCPROG_1', 'CargoCPROG-'+str(Age), 'Cargos CPROG.xlsx',wb)
    
uti.Limpiar_plantilla(ws)
ws.sheet_view.showGridLines = False
wb.save(directorio+'Cargos CPROG_'+str(Mes_str)+"_"+str(tipo_user)+'_V4.xlsx')
wb.save('Cargos CPROG.xlsx')
