...
C3=Checkbutton(raiz_guide,text="Verificacion",variable = Verificacion, onvalue=1, offvalue=0, height=2, width=7)
C3.place(x=130,y=180)

#Boton
calcular_btn=Button(raiz_guide,text="Calcular CPROG",width="30",height="2", command=asignar)
calcular_btn.place(x=60,y=230)
raiz_guide.mainloop()
...
wb.save(directorio+'Cargos CPROG_'+str(Mes_str)+"_"+str(tipo_user)+'_V5.xlsx')
wb.save('Cargos CPROG.xlsx')
