...
def verificacion_CPROG(Mes,tipo_user, mapeo_meses, Df_Agentes, directorio, directorio_archivos):
    ...
    Archivo_verif =  'Cargos CPROG_'+Mes+"_"+tipo_user+"_V5.xlsx"
...
#    wb.save(directorio+Archivo_verif_sin_form)
    ...
    #Insumos para acceder a archivos de publicación y verificación
        ...
        Archivo = Nombre + "_CargoCPROG_" + Mes_pub + Mes[2:4] + ".xlsx"
        ...
        try:
            ...
            df_insumos_CPROG_verif.columns = ['A_NombreCorto','A_Nombre','VenSTN','VenNI','VenI', 'NMA_2' ,'AIMCP_2','CPROG','NMA','AIMCP']
            ...
            df_CPROG_verif = pd.read_excel(directorio+Archivo_verif_sin_form, sheet_name = Nombre_hoja, nrows= 2, usecols = 'B:E', skiprows= range(1,11), header = None)
            df_CPROG_verif.columns = ['A_NombreCorto','CAP','Ing_Dev','CPROG']
            ...
            Equal_df_AIMCP = df_AIMCP[['MES','IPPM2','VenSTN','VenNI','VenI']].equals(df_AIMCP_verif[['MES','IPPM2','VenSTN','VenNI','VenI']])
            ...
            uti.Copiar_DF_excel(Verif_df_CPROG_verif.to_frame(), ws, 12, 6, thin_border)
